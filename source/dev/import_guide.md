...
Also, imports are always put at the top of the file. We require that imports are alphabetically sorted, and automatically separated into sections and by type. If you run:
```
tox -e checkformatting
```
in the directory enclosing the ***tox.ini*** file, you will be notified of any irregularity. It is the `isort` package that accomplishes this task (see the [isort] documentation for more information).
